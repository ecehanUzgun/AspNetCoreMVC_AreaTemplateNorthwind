...
//        => optionsBuilder.UseSqlServer("server=KDK-404-PCEG-YZ;database=northwind;uid=sa;pwd=123;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SatisRaporu>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("SatisRaporu");

            entity.Property(e => e.Açıklama).HasColumnType("ntext");
            entity.Property(e => e.Fiyat).HasColumnType("money");
            entity.Property(e => e.Kategori).HasMaxLength(15);
            entity.Property(e => e.Müşteri).HasMaxLength(40);
